...
/*
go build -gcflags="-d=ssa/check_bce/debug=1" bounds-check-elimination.go
# command-line-arguments
.\bounds-check-elimination.go:6:10: Found IsInBounds
.\bounds-check-elimination.go:23:11: Found IsInBounds
*/
